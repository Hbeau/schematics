...
<div class="modal fade" id="myModal<?php echo $id?>" role="dialog">
    ...
    foreach ($images as $img){
                            ...
                            <div class="item">
                                ...
                                <img
                                     src=" <?php echo site_url("uploads/schema/image/".$folder."/".$images[0])?>" alt="Chania" width="450" height="345">
                            </div>
                            ...
                            <div class="item">
                                <img
                                     src="http://static.planetminecraft.com/files/resource_media/screenshot/1317/dsadsadsadsadas_5327294.jpg" alt="Chania" width="450" height="345">
                            </div>
